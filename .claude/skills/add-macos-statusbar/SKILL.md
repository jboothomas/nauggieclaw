...
```bash
launchctl list | grep com.nauggieclaw.statusbar
```
...
Create `~/Library/LaunchAgents/com.nauggieclaw.statusbar.plist`, substituting the actual values
...
<dict>
    <key>Label</key>
    <string>com.nauggieclaw.statusbar</string>
...
```bash
launchctl load ~/Library/LaunchAgents/com.nauggieclaw.statusbar.plist
```
...
```bash
launchctl unload ~/Library/LaunchAgents/com.nauggieclaw.statusbar.plist
rm ~/Library/LaunchAgents/com.nauggieclaw.statusbar.plist
rm dist/statusbar
```
